 ...
 */
class ZipCodeExtractor extends AbstractRegexExtractor
{
    ...
    /**
     * CityExtractor constructor.
     * @param string $country
     */
    public function __construct(string $country = 'FR')
    {
    ...
    public function getRegexes(): array
    {
        ...
        if (isset($this->patterns[$this->country])) {
            $regex[] = '/'.$this->patterns[$this->country].'/';
        }
