...
use Alahaxe\SimpleTextMatcher\Entities\Extractors\Regex\ZipCodeExtractor;
 ...
 */
class ZipCodeExtractorTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->extractor = new ZipCodeExtractor();
    }
